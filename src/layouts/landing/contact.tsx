...
const Contact = () => {
  ...
  return (
    <Container className="flex flex-col justify-center gap-8 pt-10 pb-16 sm:pt-16 lg:justify-between lg:flex-row">
      <MotionComponent
        tag="div"
        duration={1}
        initialO={0}
      ...
      >
        <form className="space-y-4">
          <div className="space-y-1">
            <label htmlFor="name" className="text-sm font-bold md:text-base text-dark">
              Name
            </label>
          ...
          <div className="space-y-1">
            ...
            <input type="email" id="email" className="input-form" placeholder="icodeuu@gmail.com" required onChange={handleChange} />
          </div>
          <div className="space-y-1">
            <label htmlFor="number" className="text-sm font-bold md:text-base text-dark">
              Number
            </label>
            <input type="number" id="number" className="input-form" placeholder="085183154204" required onChange={handleChange} />
          </div>
          <div className="space-y-1">
            <label htmlFor="services" className="text-sm font-bold md:text-base text-dark">
