    ...
    <>
      ...
      <section className="relative bg-black">
        ...
        <div className="bg-gradient-to-b from-blue/50 to-orange/50">
          <Container className="grid grid-cols-3 gap-8 pt-16 pb-52">
            <>
            ...
            <div className="relative col-span-3 px-8 py-12 space-y-4 overflow-hidden bg-gradient-to-r from-orange to-yellow rounded-xl">
              <div className="absolute -top-16 -right-16">
                <Images src="/images/service/circle.png" alt="circle" className="w-40 h-40" />
              </div>
